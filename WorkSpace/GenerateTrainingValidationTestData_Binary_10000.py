...
with gzip.open("../RunningBikingTrainValidTest/training_set_running_and_biking_10000.json.gz", 'wb') as file1:
    for workout in train_list:
        file1.write(workout)
print("Finished writing training set\n")

with gzip.open("../RunningBikingTrainValidTest/validation_set_running_and_biking_10000.json.gz", 'wb') as file2:
    for workout in validation_list:
        file2.write(workout)
print("Finished writing validation set\n")

with gzip.open("../RunningBikingTrainValidTest/test_set_running_and_biking_10000.json.gz", 'wb') as file3:
